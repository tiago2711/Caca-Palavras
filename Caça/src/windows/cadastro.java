...
public class cadastro extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        resenha = new javax.swing.JPasswordField();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(login)
                            .addComponent(nome)
                            .addComponent(senha, javax.swing.GroupLayout.DEFAULT_SIZE, 317, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(resenha, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String aux,aux2;
        if(senha.getSelectedText()==resenha.getSelectedText()){
            String query = "insert into usuario values ('"+login.getText().trim()+"','"+nome.getText().trim()+"','"+senha.getText().trim()+"','"+pergunta.getText().trim()+"','"+resposta.getText().trim()+"');";
            bd.executeUpdate(query);
            JOptionPane.showMessageDialog(rootPane, "Conta Criada com sucesso! \nEntre e inicio o jogo");
        }else{
            JOptionPane.showMessageDialog(rootPane, "Existe informação errada!");
    ...
    private javax.swing.JPasswordField resenha;
